class MapeeController{
  constructor(API){
    ...
    angular.element('.map').data('map', this.map);
...
export const MapeeComponent = {
    templateUrl: './views/app/components/mapee/mapee.component.html',
    controller: MapeeController,
    controllerAs: 'vm',
    bindings: {}
}
